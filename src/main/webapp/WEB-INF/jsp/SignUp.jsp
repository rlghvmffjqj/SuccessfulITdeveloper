	...
	<div style="text-align: -webkit-center;">
		<div style="text-align: -webkit-center; margin-top: 11%;">
			<form id="form" method="post">
				...
				<div style="margin-top: 10px;">
					<input type="password" style="width:350px; padding-inline: 10px;"  id="usersPw" name="usersPw" class="form-control" required="required" placeholder="비밀번호">
				</div>
				<div class="check_wrap" style="width: 375px; text-align: left;">
					<span id="pwdEssential" style="color: red; font-size: 13px; display: none;">※ 필수 정보입니다.</span>
				</div>
				<div style="margin-top: 10px;">
					<input type="password" style="width:350px; padding-inline: 10px;"  id="usersPwReconfirm" name="usersPwReconfirm" class="form-control" required="required" placeholder="비밀번호 재확인">
				</div>
				<div class="check_wrap" style="width: 375px; text-align: left;">
				...
				<div style="margin-top: 10px;">
					<input type="text" style="width:350px; padding-inline: 10px;"  id="employeeName" name="employeeName" class="form-control" required="required" placeholder="이름">
				</div>
				<div class="check_wrap" style="width: 375px; text-align: left;">
					<span id="nameEssential" style="color: red; font-size: 13px; display: none;">※ 필수 정보입니다.</span>
				</div>
				<div style="margin-top: 10px;">
					<input type="email" pattern=".+@" style="width:350px; padding-inline: 10px;"  id="employeeEmail" name="employeeEmail" class="form-control" required="required" placeholder="이메일">
				</div>
				<div class="check_wrap" style="width: 375px; text-align: left;">
				...
				<div style="margin-top: 10px; text-align: -webkit-center;">
					<button style=" border: none; width: 375px; height: 50px;" type="button" id="btn" class="btn btn-primary btn-block" onClick="signUp();">회원가입</button>
				</div>
